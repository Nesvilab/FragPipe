...
workflow.description=Workflow for analysis of FPOP data using a hybrid (variable modification and detailed mass offset) search. Group-based FDR filtering included.
