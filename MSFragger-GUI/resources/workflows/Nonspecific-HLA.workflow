...
msfragger.table.var-mods=15.994900,M,true,2; 42.010600,[^,true,1; 79.966330,STY,false,3; -17.026500,nQ,true,1; -18.010600,nE,true,1; 119.004100,C,true,1; 0.984020,N,false,1; 8.014199,K,false,1; 10.008269,R,false,1; 0.000000,site_10,false,1; 0.000000,site_11,false,1; 0.000000,site_12,false,1; 0.000000,site_13,false,1; 0.000000,site_14,false,1; 0.000000,site_15,false,1; 0.000000,site_16,false,1
...
workflow.description=<p style\="margin-top\: 0in"> Nonspecific search, with recommended settings for HLA peptides. Peptide length 7-25. MSFragger search assumes cysteines were not alkylated (i.e. samples were not treated with iodoacetamide). Cysteinylation (C+119) is specified as variable modification. PSM validation with Percolator. Protein FDR filter is not applied, so each output file (PSM, ion, peptide) is filtered to 1% FDR at that level. If needed, extend to add label-free quantifcation (using IonQuant) or spectral library building with EasyPQP. </p>
