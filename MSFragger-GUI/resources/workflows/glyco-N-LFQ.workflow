...
workflow.description=<p style\="margin-top\: 0"> For search and label-free quantitation of enriched N-glycopeptides fragmented with CID/HCD. Method can be adapted for other fragmentation methods by comparing MSFragger settings to the glyco-N-hybrid workflow. </p>
