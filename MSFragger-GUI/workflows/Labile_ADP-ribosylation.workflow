...
peptide-prophet.cmd-opts=--nonparam --expectscore --decoyprobs --masswidth 1000.0
...
ptmprophet.cmdline=--keepold --static --fragppmtol 20 --em 1 --mods STY\:79.966331,M\:15.9949,SKREDTY\:541.06111 --minprob 0.5
...
workflow.description=<p style\="margin-top\: 0"> Searches for ADP-ribosylation with combined labile/nonlabile search. Settings are for HCD/CID data. For Hybrid (EThcD, etc), change MSFragger ion types and diagnostic fragment settings. </p>
