...
tmtintegrator.philosoher-msstats=true
...
workflow.description=Workflow for photoaffinity labeling (PAL) data. Light label mass\: 436.22565, heavy label mass\: 442.2633. L\:H quantiifcation with IonQuant. Mass offset search.
