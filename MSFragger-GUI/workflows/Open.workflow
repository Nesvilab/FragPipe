...
workflow.description=<p style\="margin-top\: 0in"> Open search workflow for PTM analysis. MSFragger localization-aware open search (LOS) algorithm, with mass calibration and parameter optimization. Mass range -150 to 500 Da, with Methionine oxidation and N-term Acetyl included as variable modifications. PeptideProphet with extended mass model. Crystal-C for artifact removal. PTM-Shepherd for mass shift summarization. </p>
