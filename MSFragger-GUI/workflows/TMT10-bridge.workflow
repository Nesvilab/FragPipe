...
workflow.description=<p style\="margin-top\: 0"> TMT 10-plex, quantification from MS2. TMT-Integrator with Bridge channel (labeled as 'pool' in the annotation files), data summarization at the gene level. Printing results with three normalization options (None; MD\: Median Centering; GN\: median centering with MAD variance scaling. MSFragger search with trypsin and allowing cleavage between KR and P ("strict trypsin"). Overlabeling on S is added as variable modification. This workflow is close to the one used for CPTAC data analysis. </p>
workflow.input.data-type.im-ms=false
workflow.input.data-type.regular-ms=true
workflow.process-exps-separately=false
workflow.saved-with-ver=13.0-RC11
