...
workflow.description=Perform closed search, followed by label free quantification with IonQuant. Need to choose the right MS data type (Regular MS vs IM-MS).
workflow.input.data-type.im-ms=false
workflow.input.data-type.regular-ms=true
workflow.process-exps-separately=false
workflow.saved-with-ver=13.0-RC10
