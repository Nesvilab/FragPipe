...
msfragger.table.var-mods=15.994900,M,true,2; 42.010600,[^,true,1; 464.285960,C,true,2; 470.299770,C,true,2
...
workflow.description=<p class\="MsoNormal" style\="margin-bottom\: 0in; line-height\: normal"> Workflow for cysteine activity-based protein profiling method isoTOP-ABPP\: Weerapana, E., Wang, C., Simon, G.&nbsp;et al.&nbsp;Quantitative reactivity profiling predicts functional cysteines in proteomes.&nbsp;Nature&nbsp;468,&nbsp;790\u2013795 (2010). </p> \n<p class\="MsoNormal" style\="margin-bottom\: 0in; line-height\: normal"> A static modification of +57.02146 on cysteine (iodoacetamide alkylation) is specified as fixed modification, and +464.28596 (light probe) and +470.29977 (heavy probe) were specified on cysteine to account for probe modifications with the either light or heavy variants of the IA-probe-TEV adduct. In addition, Met oxidation and N-terminal Acetyl are specified as variable modifications. 20 ppm precursor tolerance, parameter optimization enabled. Fully tryptic search, up to 2 missed cleavages. Rescoring with MSBooster. Validation with Percolator and ProteinProphet. Relative quantification of peptides with light/heavy probe using IonQuant. </p>
