...
public class QuantLabel {
  ...
  static {
    ...
    labels.add(new QuantLabel("TMT", "TMT-10", Arrays.asList("126, 127N, 127C, 128N, 128C, 129N, 129C, 130N, 130C, 131".split("[,\\s]+"))));
    labels.add(new QuantLabel("TMT", "TMT-11", Arrays.asList("126, 127N, 127C, 128N, 128C, 129N, 129C, 130N, 130C, 131C".split("[,\\s]+"))));
