...
import umich.msfragger.gui.FragpipeOnMessages;
import umich.msfragger.gui.FragpipeUiHelpers;
...
import umich.msfragger.gui.Tooltips;
...
//        SwingUtils.setFileChooserPath(fc, dir);
  ...
  public void onMessageLcmsFilesList(MessageLcmsFilesList m) {
    if (m.type == MessageType.REQUEST) {
      List<InputLcmsFile> files = tableModelRawFiles != null ? tableModelRawFiles.dataCopy() : Collections
          .emptyList();
