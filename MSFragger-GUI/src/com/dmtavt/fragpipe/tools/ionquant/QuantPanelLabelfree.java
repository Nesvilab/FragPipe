...
//    ionquant.label :: Labels <=> <string>
    ...
    FormEntry feRequant = mu.feb(uiComboRequant).name("ionquant.requantify").tooltip("Re-quantifying unidentified ions in labelling quantification").label("Re-quantify").create();
