...
public class TabRun extends JPanelWithEnablement {
  ...
  private JPanel createPanelTop() {
    ...
    feWorkdir.browseButton(() -> {
      JFileChooser fc = FileChooserUtils
          .create("Select output directory", false, FcMode.DIRS_ONLY);
      FileChooserUtils.setPath(Stream.of(uiTextWorkdir.getNonGhostText(), Fragpipe.pr));
    });
  }
