...
workflow.description=<p style\="margin-top\: 0">example workflow file for jobs. Based on Default workflow</p>
workflow.input.data-type.im-ms=false
workflow.input.data-type.regular-ms=true
workflow.misc.save-sdrf=true
workflow.misc.sdrf-type=Default
workflow.saved-with-ver=23.0-build32
