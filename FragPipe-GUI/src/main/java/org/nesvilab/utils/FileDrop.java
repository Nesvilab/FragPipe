 ...
 * <tt>System.out</tt>) into the full constructor. A
 * <tt>null</tt>
...
public class FileDrop {
   ...
   * elements contained within as drop targets, though only the top level container will change
   * borders.
   *
   ...
   * set drop targets. If your component is a
   * <tt>java.awt.Container</tt>, then each of its children components will
   * also listen for drops, though only the parent will change borders. With Debugging turned on,
   * more status messages will be displayed to
   * <tt>out</tt>. A common way to use this constructor is with
   * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the
   * parameter <tt>out</tt> will result in no debugging output.
  ...
  /**
   * This is the event that is passed to the FileDropListener#filesDropped filesDropped(...) method
   * in your FileDropListener when files are dropped onto a registered drop target.
   *
   * <p>
   ...
   * like when you're moving data out of a list, say, you can use the {@link
   * TransferableObject.Fetcher} inner class to return your object Just in Time. For example:
   * <pre><code>
   *      ...
  ...
  public static class TransferableObject implements java.awt.datatransfer.Transferable {
     ...
     * TransferableObject}, and third the java.awt.datatransfer.DataFlavor.stringFlavor.
     *
