...
public class MessageIonQuantUpdateAvailable {

  public final String newVersion;
  public final String manualDownloadUrl;

  public MessageIonQuantUpdateAvailable(String newVersion, String manualDownloadUrl) {
  ...
  public String toString() {
    return new StringJoiner(", ",
        MessageIonQuantUpdateAvailable.class.getSimpleName() + "[", "]")
