...
public class MessageDiaTracerUpdateAvailable {

  public final String newVersion;
  public final String manualDownloadUrl;

  public MessageDiaTracerUpdateAvailable(String newVersion, String manualDownloadUrl) {
  ...
  public String toString() {
    return new StringJoiner(", ",
        MessageDiaTracerUpdateAvailable.class.getSimpleName() + "[", "]")
