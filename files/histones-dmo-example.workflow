...
msfragger.mass_offsets_detailed=0.00000(aa\=);27.99490(aa\=KST);68.02620(aa\=K);72.02110(aa\=K);104.02620(aa\=K);86.00040(aa\=K);86.03680(aa\=K);100.01600(aa\=K);114.03170(aa\=K);56.02620(aa\=STY);114.04293(aa\=K);159.06842(aa\=Q);79.96633(aa\=STY);162.05283(aa\=K);108.02113(aa\=K);88.01604(aa\=K);39.99492(aa\=R);54.01057(aa\=R);80.02621(aa\=R);144.04225(aa\=R);132.05751(aa\=K)
msfragger.max_fragment_charge=1
msfragger.max_variable_mods_combinations=10000000
...
peptide-prophet.cmd-opts=--decoyprobs --ppm --accmass --nonparam --expectscore --minpeplen 6
...
phi-report.filter=--sequential --prot 0.01 --mods M\:15.9949,K\:56.0262,S\:56.0262,T\:56.0262,Y\:56.0262,K\:70.0419,K\:42.0106,K\:42.047,K\:28.0313,R\:10.0083,S\:-18.0106,E\:-18.0106
...
workflow.description=MSFragger detailed mass offset search for rare histone modifications, with common histone modifications as variable mods. Note\: includes propionyl derivatization of Lys (+56). Group FDR filtering with unmodified peptides, common histone mods, and rare histone mods in separate groups. Label free quant is enabled.
