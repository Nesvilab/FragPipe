...
workflow.description=<p style\="margin-top\: 0"> Basic TMT 10-plex workflow, with quantification from MS3. TMT-Integrator with virtual reference approach, median-centering normalization, data summarization at the gene level. </p>
