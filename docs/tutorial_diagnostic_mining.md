...
## Tutorial contents
* [Diagnostic ion mining overview](./tutorial_diagnostic_mining#diagnostic-ion-mining-overview)
* [Running a diagnostic ion mining search using the default workflow](./tutorial_diagnostic_mining#running-a-diagnostic-ion-mining-search-using-the-default-workflow)
* [Interpreting results](./tutorial_diagnostic_mining#interpreting-results)
* [Using PTM fragmentation patterns in subsequent labile searches](./tutorial_diagnostic_mining#using-ptm-fragmentation-patterns-in-subsequent-labile-searches)

### Diagnostic ion mining overview
The diagnostic ion mining module is embedded within PTM-Shepherd. It allows you to identify fragmentation patterns for PTMs identified via open searches or mass offset searches. Three types of fragmentation patterns are looked for. Each of these corresponds to an ion type that can be used in [MSFragger Labile mode](./tutorial_labile).
...
![](../images/diagnostic-mining-overview.png)
...
![](../images/diagnostic-mining_1.png)
...
![](../images/diagnostic-mining_2.png)
...
![](../images/diagnostic-mining_3.png)
...
![](../images/diagnostic-mining_4.png)

<br/>

### Interpreting results
PTM-Shepherd created a folder called "ptm-shepherd-output" inside your output folder. The most relevant files for this analysis are the "global.profile.tsv" and the "global.diagmine.tsv". For a description of the output tables, check out our [Guide to FragPipe Results](./tutorial_fragpipe_outputs).
...
![](../images/diagnostic-mining_5.png)
...
![](../images/diagnostic-mining_6.png)

<br/>

### Using PTM fragmentation patterns in subsequent labile searches
Now that we have some PTM fragmentaion information, we can use these patterns in the [MSFragger Labile mode](./tutorial_labile).
