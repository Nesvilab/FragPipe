...
##### Tutorial contents
* [Load a custom workflow](./tutorial_custom_mass_offset#load-a-custom-workflow)
* [Inspect the search parameters](./tutorial_custom_mass_offset#inspect-the-search-parameters)
* [Get a sequence database](./tutorial_custom_mass_offset#get-a-sequence-database)
* [Set the custom annotation file](./tutorial_custom_mass_offset#set-the-custom-annotation-file)
* [Pick an output location and run](./tutorial_custom_mass_offset#pick-an-output-location-and-run)
* [Examine the results](./tutorial_custom_mass_offset#examine-the-results)
...
![](../images/custom-offset-workflowtab.png)

<br/>

### Get a sequence database
You can download a human protein database file [using FragPipe](./tutorial_fragpipe#specify-a-protein-sequence-database). On the Database tab, click the ‘Download’ button. Follow the prompts to use the default settings (reviewed human sequences with common contaminants).
...
![](../images/custom-offset-ptmshepherd.png)
...
<img src="../images/custom-offset-deltamass.png" width="600px" align="middle"/>
...
![](../images/custom-offset-histogram.png)
