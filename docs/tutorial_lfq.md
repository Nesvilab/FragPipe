...
* [Load the data](./tutorial_lfq#load-the-data)
* [Load the LFQ-MBR workflow](./tutorial_lfq#load-the-lfq-mbr-workflow)
* [Fetch a sequence database](./tutorial_lfq#fetch-a-sequence-database)
* [Inspect the search and quantification settings](./tutorial_lfq#inspect-the-search-and-quantification-settings)
* [Set the output location and run](./tutorial_lfq#set-the-output-location-and-run)
* [Inspect the results](./tutorial_lfq#inspect-the-results)


### Open FragPipe
When you launch FragPipe, check that MSFragger, IonQuant, and Philosopher are configured. (If you haven’t downloaded them yet, use their respective ‘Download / Update’ buttons. Please see the tutorials [here](./tutorial_fragpipe#configure-fragpipe) and [here](./tutorial_setup_fragpipe). Python is not needed for these exercises.)
...
![](../images/lfq-results1.png)


A guide to output files, with descriptions of each column in the reports, can be found [here](./tutorial_fragpipe_outputs).
