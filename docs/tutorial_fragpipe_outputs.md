...
Also see our [guide to using FragPipe](./tutorial_fragpipe).




#### Main report files
* [psm.tsv](./tutorial_fragpipe_outputs#psmtsv) (from Philosopher, updated by PTM-Shepherd and IonQuant)
* [ion.tsv](./tutorial_fragpipe_outputs#iontsv) (from Philosopher, overwritten by IonQuant)
* [peptide.tsv](./tutorial_fragpipe_outputs#peptidetsv) (from Philosopher, overwritten by IonQuant)
* [protein.tsv](./tutorial_fragpipe_outputs#proteintsv) (from Philosopher, overwritten by IonQuant)
* [combined_ion.tsv](./tutorial_fragpipe_outputs#combined_iontsv) (from Philosopher, overwritten by IonQuant)
* [combined_modified_peptide.tsv](./tutorial_fragpipe_outputs#combined_modified_peptidetsv) (from IonQuant)
* [combined_peptide.tsv](./tutorial_fragpipe_outputs#combined_peptidetsv) (from Philosopher, overwritten by IonQuant)
* [combined_protein.tsv](./tutorial_fragpipe_outputs#combined_proteintsv) (from Philosopher, overwritten by IonQuant)
...
* [global.profile.tsv](./tutorial_fragpipe_outputs#globalprofiletsv)
* [global.diagmine.tsv](./tutorial_fragpipe_outputs#globaldiagminetsv)
* [global.modsummary.tsv](./tutorial_fragpipe_outputs#globalmodsummarytsv)
...
* [gene](./tutorial_fragpipe_outputs#gene)
* [protein](./tutorial_fragpipe_outputs#protein)
* [peptide](./tutorial_fragpipe_outputs#peptide)
* [multi-site](./tutorial_fragpipe_outputs#multi-site)
* [single-site](./tutorial_fragpipe_outputs#single-site)
...
* [ion_label_quant.tsv](./tutorial_fragpipe_outputs#ion_label_quanttsv)
* [peptide_label_quant.tsv](./tutorial_fragpipe_outputs#peptide_label_quanttsv)
* [protein_label_quant.tsv](./tutorial_fragpipe_outputs#protein_label_quanttsv)



##### Other reports
* protein.fas - FASTA file containing the FDR-filtered protein sequences identified in the analysis, generated by Philosopher
* MSstats.csv - protein abundance report formatted for use with [MSstats](https://msstats.org/) (see the [tutorial](./tutorial_msstats)), generated by IonQuant
...
**Index** gene name (works best if the analyses were run with properly-formatted FASTA sequence databases, see [this page](./tutorial_fragpipe#specify-a-protein-sequence-database) for more information)
...
### ion_label_quant.tsv
##### `ion_label_quant.tsv` contains MS1-based isotopic quantification results from [IonQuant](https://ionquant.nesvilab.org/) at the ion (peptide + modification state + charge) level. See the [SILAC tutorial](./tutorial_silac) for more information. If only Light and Heavy labels are used, columns with 'Medium'/'M' will be missing.
...
##### `protein_label_quant.tsv` contains MS1-based isotopic quantification results from [IonQuant](https://ionquant.nesvilab.org/) summarized to the protein level. See the [SILAC tutorial](./tutorial_silac) for more information. If only Light and Heavy labels are used, columns with 'Medium'/'M' will be missing.
