...
fragnovo.new-tokens=
fragnovo.perform-fine-tuning=false
fragnovo.perform-lora-prediction=false
fragnovo.perform-prediction=true
fragnovo.precursor-mass-tol=50
fragnovo.run-fragnovo=false
fragnovo.timeout=3600
fragnovo.use-irt=false
freequant.mz-tol=10
...
workflow.saved-with-ver=24.1-build21