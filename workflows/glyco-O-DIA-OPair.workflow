...
fragnovo.model=diaPASEF
fragnovo.new-tokens=
fragnovo.perform-fine-tuning=true
fragnovo.perform-lora-prediction=true
fragnovo.perform-prediction=false
fragnovo.precursor-mass-tol=50
fragnovo.run-fragnovo=true
fragnovo.timeout=3600
fragnovo.use-irt=true
freequant.mz-tol=10
