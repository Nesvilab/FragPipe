...
msfragger.table.var-mods=15.9949,M,true,3; 42.0106,[^,false,1; 79.96633,STY,false,3; -17.0265,nQnC,false,1; -18.0106,nE,false,1; 304.20715,n^,false,1; 304.20715,S,false,1; 0.0,site_08,false,1; 0.0,site_09,false,1; 0.0,site_10,false,1; 0.0,site_11,false,1; 0.0,site_12,false,1; 0.0,site_13,false,1; 0.0,site_14,false,1; 0.0,site_15,false,1; 0.0,site_16,false,1
...
tmtintegrator.min_pep_prob=0.7
...
workflow.description=<p style\="margin-top\: 0">TMT 18-plex workflow for Astral data. TMTPro is specified as fixed modification, and Met oxidation is specified as variable modifications. TMT-Integrator with virtual reference approach, median-centering normalization, data summarization at the gene level. If a reference/bridge sample is available, specify the corresponding channel/sample name tag in the annotation file(s) and in TMT-Integrator tab. Please use RAW files (not mzML). For quantifications, PSMs are filtered using Purity (&gt; 0.5), SNR (summed SNR &gt; 1000) and Resolution (each channel &gt;45,000 unless channel SNR&lt;1) filters.</p>
