...
<div style={{display: "flex", gap: "10px", alignItems: "center" }}>
  <img src="https://img.shields.io/github/release/Nesvilab/FragPipe.svg" alt="Release"/>
  <img src="https://img.shields.io/github/downloads/Nesvilab/FragPipe/total.svg" alt="Downloads"/>
  <img src="https://img.shields.io/docker/pulls/fcyucn/fragpipe" alt="Docker pulls"/>
  <img src="https://img.shields.io/github/downloads/Nesvilab/FragPipe/latest/total.svg" alt="Latest Downloads"/>
  <iframe
        src="https://ghbtns.com/github-btn.html?user=Nesvilab&amp;repo=FragPipe&amp;type=star&amp;count=true&amp;"
        height={20}
        title="GitHub Stars"
      />
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/Nesvilab/FragPipe/develop/images/fragpipe-01-bg-white.png" width="350px"/>
</div>
...
## FragPipe tutorials
* [Using FragPipe](./docs/tutorial_fragpipe) (general tutorial covering all FragPipe modules)
* [Running FragPipe in command line interface](./docs/tutorial_headless)
* [Running multiple FragPipe jobs in Batch](./docs/tutorial_batch)
* [Pulling and running FragPipe using Docker or Singularity](./docs/tutorial_docker)
* PTM discovery
  * [Open search](./docs/tutorial_open)
  * [Mass offset search](./docs/tutorial_offset)
  * [Labile PTM search](./docs/tutorial_labile)
  * [Glycoproteomics search](./docs/tutorial_glyco)
  * [Custom mass offset workflow (RNA crosslinking example)](./docs/tutorial_custom_mass_offset) 
  * [Diagnostic ion mining](./docs/tutorial_diagnostic_mining)
  * [FPOP](./docs/tutorial_fpop)
* TMT/iTRAQ quantification
  * [Single plex](./docs/tutorial_tmt)
  * [Multiple plexes with a pooled reference sample](./docs/tutorial_tmt-2plexes)
  * [Streamlined activity-based protein profiling of reactive cysteines (SLC-ABPP)](./docs/tutorial_abpp)
* [Label-free quantification](./docs/tutorial_lfq)
* [SILAC (or other MS1-labeled) data](./docs/tutorial_silac)
* [DIA analysis](./docs/tutorial_DIA)
* [Novel/variant peptide detection using two-pass search](./docs/tutorial_two_pass_search)
* [Group FDR estimation for novel/variant peptide analysis](./docs/tutorial_group_fdr)
* [Use peptide prediction models from Koina for MSBooster feature generation](./docs/tutorial_koina)

## Resources
* [Interpreting output files](./docs/tutorial_fragpipe_outputs)
* [List of built-in workflows](./docs/tutorial_fragpipe_workflows)
* [FragPipe setup](./docs/tutorial_setup_fragpipe)
* [Converting LC/MS data files to mzML](./docs/tutorial_convert)
* [Setting up FragPipe on remote Linux server (with X forwarding)](./docs/tutorial_setup_x_forwarding)

## Using FragPipe with other tools
* [Running MSstats with IonQuant results](./docs/tutorial_msstats)
* [Importing results into Skyline](./docs/tutorial_skyline)
* [Importing results into Perseus](./docs/tutorial_perseus)

## Representative papers using FragPipe
* [Chemoproteomics](./docs/fragpipe_chemoproteomics_collection)
* [Immunopeptidomics](./docs/fragpipe_immunopeptidomics_collection)
* [Glycoproteomics](./docs/fragpipe_glycoproteomics_collection)
...
_DIA data acquired with overlapping/staggered windows must be [converted to mzML with demultiplexing](./docs/tutorial_convert#convert-thermo-dia-raw-files-with-staggered-windows)._
